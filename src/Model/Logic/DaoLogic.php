...
class DaoLogic
{
    ...
    private function generateDao(
        ...
        $file .= sprintf('/%s%sDao.php', $mappingClass, $extName);
...
//            $genGetters[] = $this->generateGetters($columnSchema, $tplDir);
        ...
        $use .= sprintf('use App\Model\Entity\%s\%s;', $mPath, $mappingClass);

        $data = [
            'properties'   => $propertyStr,
            'methods'      => $methodStr,
            'tableName'    => $tableSchema['name'],
            'entityName'   => $mappingClass.$extName.'Dao',
